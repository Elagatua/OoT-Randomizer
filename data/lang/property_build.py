...
ITEM_MESSAGES = [
    ...
    {
        "id": 0x90E0,
        "text": "\x08You found the \x05\x41Triforce of Power\x05\x40!",
    },
    {
        "id": 0x90E1,
        "text": "\x08You found the \x05\x45Triforce of Wisdom\x05\x40!",
    },
    {
        "id": 0x90E2,
        "text": "\x08You found the \x05\x42Triforce of Courage\x05\x40!",
    },
]
...
MISC_MESSAGES = [
    ...
    {
        "id": 0x045E,
        "text": "Switch age?\x01\x01\x1B\x05\x42Yes\x01No\x05\x40",
        "box_type": 0x00
    },
    {
        "id": 0x045F,
        "text": "Can't switch age here!\x0E\x78",
        "box_type": 0x00
    },
    {
        "id": 0x6013,
...
hintTable = {
    ...
    'Triforce of Power':                                        (["a triumph fork", "cheese", "a gold fragment"], "the Triforce of Power", "no_gender"),
    'Triforce of Wisdom':                                       (["a triumph fork", "cheese", "a gold fragment"], "the Triforce of Wisdom", "no_gender"),
    'Triforce of Courage':                                      (["a triumph fork", "cheese", "a gold fragment"], "the Triforce of Courage", "no_gender"),
    ...
    # Triforce Blitz dual always hints
    'Kak 20 and 30 Gold Skulltula Rewards':                     ("#in a peaceful village# collecting 20 and 30 spider tokens will reward...^", None, "no_gender"),
    'Kak 40 and 50 Gold Skulltula Rewards':                     ("#in a peaceful village# collecting 40 and 50 spider tokens will reward...^", None, "no_gender"),
    'DMT Biggoron and ZR Frogs Ocarina Game':                   ("#Biggoron and the Frogs of Zora River#, for retinal relief and a proud performance reward respectively...^", None, "no_gender"),
    'HF and Kak Dungeon Reward Songs':                          ("the #Ocarina of Time and ravaged village# teach respectively...^", None, "no_gender"),

    # Triforce Blitz hint shop items
    'Bomb Bag Hint':                                            ("an explosive #rumor# for sale", "Bomb Bag Hint", "no_gender"),
    'Bow Hint':                                                 ("a high-strung #rumor# for sale", "Bow Hint", "no_gender"),
    'Hookshot Hint':                                            ("a grabby #rumor# for sale", "Hookshot Hint", "no_gender"),
    'Magic Hint':                                               ("a magical #rumor# for sale", "Magic Hint", "no_gender"),
    'Goron Bracelet Hint':                                      ("a gripping #rumor# for sale", "Goron Bracelet Hint", "no_gender"),
    'Silver Gauntlets Hint':                                    ("a doubly gripping #rumor# for sale", "Silver Gauntlets Hint", "no_gender"),
    'Silver Scale Hint':                                        ("a weighty #rumor# for sale", "Silver Scale Hint", "no_gender"),
    'Wallet Hint':                                              ("an expensive #rumor# for sale", "Wallet Hint", "no_gender"),
}
...
hint_text = {
    ...
    # Triforce Blitz and Escape From Kakariko hint texts
    "echo_prefix": "They #echo# that ",
    "step": "step",
    "steps": "steps",
    "woth_count": "walking the way of the hero requires #{item_count}# {step_text}.",
    "goal_legacy": "{location_text} is on {goal_text}.",
    "goal_legacy_own": "the ",
    "goal_legacy_other": "their ",
    "goal_count": "{goal_prefix} {goal_text} requires #{item_count}# {step_text}.",
    "goal_count_own": "the",
    "goal_count_other": "your",
    "escape_from_kak_count": "{location_text} hides #{item_count}# {step_text} towards the escape from Kakariko.",
    "way_of_wanderer": "{location_text} is on the way of the #wanderer#.",
    "unlock": "{required_item_player}#{required_item}# unlocks the way to {item_player}#{item}#.",
    "unlock_wanderer": "{required_item_player}#{required_item}# unlocks the way to the #wanderer's# {item_player}#{item}#.",
    "shop_obtained": "you begin with an #obtained# {item_text}.",
    "shop_hoards": "{location_text} hoards a #{importance}# {item_text}.",
    "shop_importance_path": "path",
    "shop_importance_wanderer": "wanderer",
    "shop_importance_neglected": "neglected"
}
