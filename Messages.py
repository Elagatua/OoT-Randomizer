...
ITEM_MESSAGES: list[tuple[int, str]] = [
    ...
    (0x90E3, "\x08You found the \x05\x41Triforce of Thetoolmon\x05\x40!"),
    (0x90E4, "\x08You found the \x05\x45Triforce of JarJarChapstick\x05\x40!"),
    (0x90E5, "\x08You found the \x05\x42Triforce of Shives\x05\x40!"),
    (0x90E6, "\x08You found the \x05\x41Triforce of Tobin91\x05\x40!"),
    (0x90E7, "\x08You found the \x05\x45Triforce of KeipDaddy\x05\x40!"),
    (0x90E8, "\x08You found the \x05\x42Triforce of GENHARTALLCAPS\x05\x40!"),
    (0x90E9, "\x08You found the \x05\x41Triforce of CTESPNfantasy\x05\x40!"),
    (0x90EA, "\x08You found the \x05\x45Triforce of Kish15\x05\x40!"),
    (0x90EB, "\x08You found the \x05\x42Triforce of Jusby\x05\x40!"),
    (0x90EC, "\x08You found the \x05\x41Triforce of Dome6634\x05\x40!"),
    (0x90ED, "\x08You found the \x05\x45Triforce of Wrckingcrew\x05\x40!"),
    (0x90EE, "\x08You found the \x05\x42Triforce of Lefty\x05\x40!"),
]
