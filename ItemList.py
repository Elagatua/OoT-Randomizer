...
item_table: dict[str, tuple[str, Optional[bool], Optional[int], Optional[dict[str, Any]]]] = {
    ...
    'Triforce of Thetoolmon':                          ('Item',     True,  0x1020, {'alias': ('Triforce Piece', 1)}),
    'Triforce of JarJarChapstick':                     ('Item',     True,  0x1021, {'alias': ('Triforce Piece', 1)}),
    'Triforce of Shives':                              ('Item',     True,  0x1022, {'alias': ('Triforce Piece', 1)}),
    'Triforce of Tobin91':                             ('Item',     True,  0x1023, {'alias': ('Triforce Piece', 1)}),
    'Triforce of KeipDaddy':                           ('Item',     True,  0x1024, {'alias': ('Triforce Piece', 1)}),
    'Triforce of GENHARTALLCAPS':                      ('Item',     True,  0x1025, {'alias': ('Triforce Piece', 1)}),
    'Triforce of CTESPNfantasy':                       ('Item',     True,  0x1026, {'alias': ('Triforce Piece', 1)}),
    'Triforce of Kish15':                              ('Item',     True,  0x1027, {'alias': ('Triforce Piece', 1)}),
    'Triforce of Jusby':                               ('Item',     True,  0x1028, {'alias': ('Triforce Piece', 1)}),
    'Triforce of Dome6634':                            ('Item',     True,  0x1029, {'alias': ('Triforce Piece', 1)}),
    'Triforce of Wrckingcrew':                         ('Item',     True,  0x102A, {'alias': ('Triforce Piece', 1)}),
    'Triforce of Lefty':                               ('Item',     True,  0x1030, {'alias': ('Triforce Piece', 1)}),
